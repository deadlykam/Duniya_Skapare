...
func setup(tile:int) -> void:
    ...
    # TOOD: If no rules found then hide the buttons.
...
func _on_btn_add_pressed():
    ...
    while _counter1 < _selected_items.size():
        # TODO: Add the items to the correct data

        # Changing item bg colour to green to show added
        # _item_names.set_item_custom_bg_color(
        #     _selected_items[_counter1],
        #     _green
        # )
...
func _on_btn_remove_pressed():
    ...
    while _counter1 < _selected_items.size():
        # TODO: Remove the items from the correct data

        # Changing item bg colour to red to show removed
        # _item_names.set_item_custom_bg_color(
        #     _selected_items[_counter1],
        #     _red
        # )
